...
class TestBasic(unittest.TestCase):
    ...
    def test_get_session_url(self):
        ...
        session_url = smartpay.get_session_url(FAKE_SESSION, promotion_code=CODE)

        self.assertTrue(session_url.index(CHECKOUT_URL) == 0)
        self.assertTrue(session_url.index("%s" % (FAKE_SESSION.get("id"),)) > 0)
    ...
    def test_verify_webhook_signature(self):
        ...
        self.assertTrue(
            smartpay.verify_webhook_signature(
    ...
    def test_retry_policy(self):
        ...
        smartpay1 = Smartpay(
            ...
            api_prefix="http://127.0.0.1:3001",
            retries=5,
        )
